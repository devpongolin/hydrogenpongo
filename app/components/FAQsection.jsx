...
export default function FAQsection({productFAQS}) {  
  ...
  return (
    <div className="mx-auto md:px-[112px] px-[16px] py-[48px] pt-[65px]">
      ...
      <div className="space-y-4 flex flex-col items-center max-w-[1216px] mx-auto">
        {faqContent.faqs.map((faq, index) => (
          <div
            key={index}
            className="p-[16px] w-full rounded-lg waggle-blue-bg cursor-pointer md:py-[28px] md:px-[34px]"
            onClick={() => toggle(index)}
          >
            <div className="flex justify-between items-center">
              <h3 className="lato  font-[700] text-[18px] leading-[124%] tracking-[0] text-dark-gray md:text-[20px] md:leading-[124%]">
                {faq.question}
              </h3>
