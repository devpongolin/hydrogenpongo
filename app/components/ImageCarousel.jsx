...
const ImageCarousel = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-stone-100 p-4 md:p-8">
                  ...
                  <div className="relative z-10 h-full flex items-center p-6 md:p-8">
                    <div className="flex-1 max-w-lg">
                      ...
                      <div className="grid grid-cols-2 gap-6 mb-8">
                        {slide.features.map((feature, idx) => (
                          <div key={idx} className="flex flex-col items-center text-center">
                            ...
                            {/* Divider Line */}
                            <div className="h-px bg-white/60 w-8 mb-3"></div>
                      ...
                      <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-full font-semibold transition-colors duration-200 flex items-center gap-2">
                        {slide.buttonText}
                        <img src={btnArrowImg} alt="Arrow" className="w-4 h-4" />
                      </button>
                    </div>
                  </div>
                </div>
