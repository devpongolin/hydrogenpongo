...
export default function FrequentlyBoughtTogether() {
  return (
    <div className="dark-slate-bg md:px-[182px] md:py-[56px] px-4 py-8">
      ...
      <div className="md:hidden flex flex-col">
        <h2 className="white-text-element lexend font-medium text-[24px] leading-[100%] tracking-[-0.24px] text-center mb-6">
          {texts.sectionTitle}
        </h2>
        <div className="flex items-center justify-center gap-4 mb-6">
          <div className="flex flex-col items-center">
            <img src={CameraImage} alt={texts.products[0].alt} className="mb-[14px] object-contain" 
            loading="lazy"/>
            <h3 className="white-text-element lexend font-medium text-[14px] leading-[17px] tracking-[-0.05px] text-center mb-2">
              {texts.products[0].title}
            </h3>
        ...
        <div className="text-center">
          <div className="white-text-element lato font-medium text-[16px] leading-[19px] tracking-[0] mb-2">
            {texts.totalPriceText}
          </div>
          <div className="flex items-center justify-center gap-2 mb-4">
            <span className="gray-400 line-through text-base">{texts.totalOriginalPrice}</span>
            <span className="white-text-element lexend font-medium text-[28px] leading-[22px] tracking-[0]">{texts.totalDiscountedPrice}</span>
          </div>
          <button className="button2 button-hover2 px-6 py-[14px] lato rounded-[100px] white-text-element font-bold text-[16px] leading-[100%] cursor-pointer tracking-[0] w-full max-w-[280px]">
            {texts.buttonText}
          </button>
        </div>
      </div>
